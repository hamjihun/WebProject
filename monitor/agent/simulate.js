...
const hosts = [
  { host: 'ERP-DB01',  name: 'ERP DB 서버', os: 'Windows Server 2019', mem: 64 * GB, base: 35, disks: [['C:', 200 * GB, 120 * GB], ['D:', 2000 * GB, 1650 * GB]] },
...
function send(h) {
  ...
  const body = JSON.stringify({
    host: h.host, name: h.name || '', os: h.os, token: TOKEN,
